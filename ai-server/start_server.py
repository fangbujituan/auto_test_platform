...
def setup_environment():
    ...
    # Load graphs and http config from graph.json
    ...
    os.environ.update({
        ...
        # HTTP configuration (custom routes)
        **({"LANGGRAPH_HTTP": json.dumps(http_config)} if http_config else {}),
...
def main():
    ...
    print("📊 Token Stats API: http://localhost:2025/api/v1/token-stats/overview")
    print("📈 Token Dashboard: http://localhost:2025/token-stats/dashboard")
    print("=" * 60)
