...
from tools.utils.dom_utils import clean_dom_html, clean_dom_html_for_selectors, clean_playwright_snapshot
...
class DOMCleanerMiddleware(AgentMiddleware):
    ...
    def _pass_raw_html_to_semantic_selector(self, tool_name: str, raw_html: str):
        ...
        try:
            ...
            from tools.middleware.semantic_selector import get_semantic_selector
